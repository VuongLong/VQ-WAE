...
parser.add_argument("--is_label", type=int)
...
parser.add_argument('--data_file_path', type=str, default='WS')
...
if __name__ == "__main__":
    ...
    """
    if args.dataset == 'LATENT_BLOCK':
        _, _, train_loader, test_loader, _ = util.load_data_and_data_loaders_LATENT_BLOCK('LATENT_BLOCK', args.data_file_path, args.batch_size, args.is_label)
    else:
    ...
    for epoch in range(1, args.epochs):
        ...
        if args.save or cur_loss <= BEST_LOSS:
            ...
            print('results/{}_{}_label_{}_pixelcnn.pt'.format(args.model_name,str(args.epochs),save_is_label))

            torch.save(model.state_dict(), '/home/ubuntu/long/VQWAE/latent_results/{}_{}_label_{}_pixelcnn.pt'.format(args.model_name,str(args.epochs),save_is_label))
        else:
